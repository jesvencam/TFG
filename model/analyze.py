...
if __name__ == '__main__':
    ...
    parser.add_argument('--i', default='/Users/jesusvenacampos/Universidad/CUARTO/TFG/Repositorio/TFG/model/example/output.wav', help='Path to input file or folder. If this is a file, --o needs to be a file too.')
    parser.add_argument('--o', default='/Users/jesusvenacampos/Universidad/CUARTO/TFG/Repositorio/TFG/model/example/output.BirdNET.selection.table.txt', help='Path to output file or folder. If this is a file, --i needs to be a file too.')

...
if __name__ == '__main__':
    ...
    parser.add_argument('--o', default='model/example/output.BirdNET.selection.table.txt', help='Path to output file or folder. If this is a file, --i needs to be a file too.')
